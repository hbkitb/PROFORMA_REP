xmlport 50150 "50150_Posting_Setup_ERPG"
{
    ...
    begin
        ...
        if svar = 1 then begin
            ...
            IF GenPostSetup.FINDSET THEN
                REPEAT
                    ...
                    GenPostSetup."Sales Account" := '0000' + Felt03;
                    GenPostSetup."Sales Credit Memo Account" := '0000' + Felt03;
                    ...
                    GenPostSetup."Inventory Adjmt. Account" := '00009995';  //Felt07;
                    GenPostSetup."Direct Cost Applied Account" := '00009995';  //modkonto køb
                    GenPostSetup."Overhead Applied Account" := '00009995';     //modkonto køb

                    GenPostSetup."Purchase Variance Account" := '00009995';    //Købsafvigelse
                    GenPostSetup.MODIFY;
        ...
        if svar = 2 then begin
            ...
            IF GenPostSetup.FINDSET THEN
                REPEAT
                    ...
                    GenPostSetup."Purch. Account" := '00009995'; //120321 Felt03;  //'13800';
                                                                 //hIF STRLEN(Felt09) = 4 THEN
                                                                 //h   Felt09 := '0' + Felt09;
                                                                 //hIF STRLEN(Felt09) = 5 THEN
                    GenPostSetup."Purch. Line Disc. Account" := '0000' + Felt05;
                    GenPostSetup."Purch. Credit Memo Account" := '00009995'; //120321  Felt03;  //'13800';
                                                                             //hIF STRLEN(Felt03) = 4 THEN
                                                                             //h   Felt03 := '0' + Felt03;
                                                                             //hIF STRLEN(Felt03) = 5 THEN
            ...
            IF GenvareSetup.FINDSET THEN
                REPEAT
                    ...
                    //hIF STRLEN(Felt02) = 5 THEN
                    //141220 GenPostSetup."Sales Account" := Felt02;
                    GenvareSetup."Inventory Account" := '0000' + Felt03; //Felt06; //Felt03;  //'13800';
                    GenVareSetup."Inventory Account (Interim)" := '0000' + Felt03; //Felt06;
                                                                                   //hIF STRLEN(Felt09) = 4 THEN
        ...
        IF svar = 3 then begin
            ...
            if strlen(Felt05) < 4 then
                Felt05 := '0' + Felt05;
            if strlen(Felt06) < 4 then
                Felt06 := '0' + Felt06;
            if strlen(Felt15) < 4 then
                Felt15 := '0' + Felt15;
            if strlen(Felt16) < 4 then
                Felt16 := '0' + Felt16;
            //220321                                                                   
            if Felt02 = '2' then begin  //Debitor         
                ...
                if GenPostSetup.FindSet then
                    repeat
                        if strlen(felt05) > 1 then begin
                            GenPostSetup."Sales Account" := '0000' + Felt05;
                            GenPostSetup."Sales Credit Memo Account" := '0000' + Felt05;
                        end;
                        if strlen(Felt06) > 1 then
                            GenPostSetup."COGS Account" := '0000' + Felt06;
                        GenPostSetup.Modify;
                    until GenPostSetup.Next = 0;
            end;
            ...
            if Felt02 = '3' then begin  //kreditor
                ...
                if GenPostSetup.FindSet then
                    repeat
                        if strlen(felt05) > 1 then begin
                            GenPostSetup."Purch. Account" := '0000' + Felt05;
                            GenPostSetup."Purch. Credit Memo Account" := '0000' + Felt05;
                        end;
                        GenPostSetup.Modify;
                    until GenPostSetup.Next = 0;
            end;
            ...
            if (Felt02 <> '2') and (Felt02 <> '3') then begin  //Debitor
                ...
                if GenPostSetup.FindSet then
                    repeat
                        if strlen(felt03) > 1 then begin
                            GenPostSetup."Sales Account" := '0000' + Felt03;
                            GenPostSetup."Sales Credit Memo Account" := '0000' + Felt03;
                        end;
                        if strlen(felt04) > 1 then
                            GenPostSetup."COGS Account" := '0000' + Felt04;
                        if strlen(felt05) > 1 then
                            GenPostSetup."Sales Line Disc. Account" := '0000' + Felt05;
                        if strlen(felt15) > 1 then
                            GenPostSetup."Purch. Line Disc. Account" := '0000' + Felt15;
                        GenPostSetup."Inventory Adjmt. Account" := '00001160';
                        GenPostSetup."Purchase Variance Account" := '00009995';
                        GenPostSetup.Modify;
                    until GenPostSetup.Next = 0;
                ...
                IF GenvareSetup.FINDSET THEN
                    REPEAT
                        ...
                        //hIF STRLEN(Felt02) = 5 THEN
                        //141220 GenPostSetup."Sales Account" := Felt02;
                        GenvareSetup."Inventory Account" := '0000' + Felt06; //Felt06; //Felt03;  //'13800';
                        GenVareSetup."Inventory Account (Interim)" := '0000' + Felt06; //'7310'; //Felt06;
                                                                                       //hIF STRLEN(Felt09) = 4 THEN
        ...
        if svar = 1 then begin
            ...
            IF CustPost.FINDSET THEN
                REPEAT
                    ...
                    IF STRLEN(Felt04) = 4 THEN
                       Felt04 := '0' + Felt04;
                       */
                    CustPost."Receivables Account" := '0000' + Felt08;
                    CustPost."Payment Disc. Debit Acc." := '00005685'; //Felt04;
                    CustPost."Payment Disc. Credit Acc." := '00005685'; //Felt04;

                    CustPost."Interest Account" := '00005600';
                    CustPost."Additional Fee Account" := '00001220';

                    CustPost."Invoice Rounding Account" := '00009995';
                    CustPost."Debit Curr. Appln. Rndg. Acc." := '00009995';
                    CustPost."Credit Curr. Appln. Rndg. Acc." := '00009995';
                    CustPost."Debit Rounding Account" := '00009995';
                    CustPost."Credit Rounding Account" := '00009995';
                    CustPost."Payment Tolerance Debit Acc." := '00009995';
                    CustPost."Payment Tolerance Credit Acc." := '00009995';
            ...
            ELSE BEGIN
                ...
                IF STRLEN(Felt04) = 4 THEN
                   Felt04 := '0' + Felt04;
                   */
                CustPost."Receivables Account" := '0000' + Felt08;  //020321   
                CustPost."Payment Disc. Debit Acc." := '00005685'; //Felt04;
                CustPost."Payment Disc. Credit Acc." := '00005685'; //Felt04;
